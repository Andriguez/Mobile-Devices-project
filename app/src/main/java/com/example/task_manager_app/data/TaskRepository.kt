...
class TaskRepository {
    suspend fun loadTasks(): List<Task> =
        withContext(Dispatchers.IO) {
            ...
            listOf(
                Task(1, "Acheter du lait", "Supermarché, rayon lait", LocalDate.now(), LocalTime.of(9, 30)),
                Task(2, "Appeler Alice", "Rappeler au sujet du projet", LocalDate.now(), LocalTime.of(14, 0)),
